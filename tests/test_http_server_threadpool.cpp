...
void run() {
    ...
    //olivia::http::HttpServer::ptr server(new olivia::http::HttpServer(true, worker.get(), olivia::IOManager::GetThis()));
    olivia::http::HttpServer::ptr server(new olivia::http::HttpServer(false));
...
int main(int argc, char** argv) {
    olivia::IOManager iom(3, true, "main");
