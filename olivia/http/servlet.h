...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(olivia::http::HttpRequest::ptr request
                   , olivia::http::HttpResponse::ptr response
                   , olivia::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (olivia::http::HttpRequest::ptr request
                   , olivia::http::HttpResponse::ptr response
                   , olivia::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(olivia::http::HttpRequest::ptr request
                   , olivia::http::HttpResponse::ptr response
                   , olivia::http::HttpSession::ptr session) override;
private:
    // 回调函数
    callback m_cb;
};
